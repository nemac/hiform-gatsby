  ...
  render() {
    ...
    return (
      <Fragment>
        <Gallery>
          {images.map((img, i) => (
            <GalleryItem key={img.childImageSharp.sizes.src}>
              <a href={img.childImageSharp.sizes.src} alt="Car Image" onClick={e => this.handleClick(e, i)}>
                <StyledImg sizes={img.childImageSharp.sizes} />
              </a>
            </GalleryItem>
          ))}
        </Gallery>
        ...
        <LightboxModal visible={showLightbox} onKeyUp={e => this.handleKeyDown(e)}>
          <LightboxContent>
            <Img sizes={images[selectedImage].childImageSharp.sizes} />
            <Controls>
